...
import buildChartData from '~api/benchmarking-data/financial-metrics/r-and-d-of-revenue-ltm';

const RdOfRevenueLtm = ({ settings, ...props }) => {
  return (
    <MainLayout {...settings}>
...
export default RdOfRevenueLtm;

RdOfRevenueLtm.propTypes = {
  settings: PropTypes.shape(MainLayoutType).isRequired,
};

export async function getStaticProps() {
  return getChartPageData(
    '/financial-metrics/r-and-d-of-revenue-ltm',
    buildChartData,
  );
}
