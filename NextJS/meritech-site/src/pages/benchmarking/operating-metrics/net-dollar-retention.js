...
import buildChartData from '~api/benchmarking-data/operating-metrics/net-dollar-retention';

const NetDollarRetention = ({ settings, ...props }) => {
  return (
    <MainLayout {...settings}>
...
export default NetDollarRetention;

NetDollarRetention.propTypes = {
  settings: PropTypes.shape(MainLayoutType).isRequired,
};

export async function getStaticProps() {
  return getChartPageData(
    '/operating-metrics/net-dollar-retention',
    buildChartData,
  );
}
