...
async function sendEmail({
  ...
  return new Promise((resolve, reject) => {
    const template = `
      ...
      <p><strong>Social Platform:</strong> <i>${socialPlatform}</i></p>
      <p><strong>Social Handle:</strong> <i>${socialHandle}</i></p>
      <p><strong>Video Link:</strong> <i>${videoLink}</i></p>
