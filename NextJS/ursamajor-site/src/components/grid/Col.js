...
function addHidden(name, val, classNames) {
  if (val) {
    classNames.push(`hidden-${name}`)
  }
}
...
const Col = ({
  ...
  addHidden('xs', xsHidden, classNames)
  addHidden('sm', smHidden, classNames)
  addHidden('md', mdHidden, classNames)
  addHidden('lg', lgHidden, classNames)
  addHidden('xl', xlHidden, classNames)
