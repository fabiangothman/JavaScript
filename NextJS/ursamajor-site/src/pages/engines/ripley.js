...
export async function getStaticProps() {
  try {
    ...
    const enginesPage = await enginesResult.items
      ...
      .shift()
    const enginePageResult = await ContentfulAPI.getEntry('1syNRc6bSx1X7u71RfAuE1')
      ...
      props: {
        page: {
          ...
          engine: {
            ...
            engineFullHeight: getImageParams(page.engine.fields.imageFullHeight),
