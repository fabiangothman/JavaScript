...
//Se ejecuta en cualquier momento que se llame al servidor
function logger (req, res, next) {
    console.log(`Request from route: ${req.protocol}://${req.get('host')}${req.originalUrl}.`);
    next();
}

//Usar el Middleware "logger" en todos los request
app.use(logger);
