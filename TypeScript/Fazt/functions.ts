...
const getSubstract = (num1: number, num2: number): number => num1 - num2;
...
const concatName = (firstname: string, lastname?: string): string => (lastname===undefined) ? firstname : `${firstname} ${lastname}`;
